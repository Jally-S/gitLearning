...
<html>
	...
	<center>
		<form name = "f">
			菜单编号：<input type="text" name="menuid"/><br/>
			菜单名字：<input type="text" name="menuname" class="input"/><br/>
			角色路径:&nbsp;&nbsp;&nbsp;&nbsp;：<input type="text" name="menupath"class="input"/>
		<br/>
