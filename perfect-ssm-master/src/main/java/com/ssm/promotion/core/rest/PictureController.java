package com.ssm.promotion.core.rest;
...
public class PictureController
{
	...
	public String list(@RequestParam(value = "page", required = false) String page,
			@RequestParam(value = "rows", required = false) String rows, Picture picture, HttpServletResponse response)
			throws Exception
	{
	...
	public Result<Object> list(@RequestParam(value = "page", required = false) String page,
			@RequestParam(value = "rows", required = false) String rows, Picture picture) throws Exception
	{
		Map<String, Object> map = new HashMap<String, Object>();
		if (page != null && rows != null)
		{
		...
		List<Picture> pictureList = pictureService.findPicture(map);
		Result<Object> result = ResultGenerator.genSuccessResult();
		Long total = pictureService.getTotalPicture(map);
	...
	@ResponseBody
	public Result<Object> save(@RequestBody Picture picture) throws Exception
	{
		int resultTotal = 0;
	...
	@ResponseBody
	public Result<Object> update(@RequestBody Picture picture) throws Exception
	{
		int resultTotal = 0;
	...
	@ResponseBody
	public Result<Object> delete(@PathVariable(value = "ids") String ids) throws Exception
	{
	...
	@ResponseBody
	public Result<Object> findById(@PathVariable("id") String id) throws Exception
	{
