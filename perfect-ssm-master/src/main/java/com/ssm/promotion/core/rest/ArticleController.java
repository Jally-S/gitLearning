...
public class ArticleController
{
	...
	@ResponseBody
	public Result<Object> save(@RequestBody Article article) throws Exception
	{
		int resultTotal = 0;
	...
	@ResponseBody
	public Result<Object> update(@RequestBody Article article) throws Exception
	{
		int resultTotal = 0;
	...
	@ResponseBody
	public Result<Object> delete(@PathVariable("ids") String ids) throws Exception
	{
