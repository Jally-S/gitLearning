...
<div class="pages">
	...
	<c:if test="${pageData.list.size() > 0 }">
	 ...
	 -->
	 <a href="goodsList_getAllNews?page=1" class="p_pre">首页</a>
	 <a href="goodsList_getAllNews?page=${page-1}" class="p_pre">上一页</a>
	 <a href="javascript:void(0);" class="cur">${page }/${pages }</a>
	 <a href="goodsList_getAllNews?page=${page+1}" class="p_pre">下一页</a>
	 <a href="goodsList_getAllNews?page=${pages }" class="p_pre">尾页</a>
</div>
