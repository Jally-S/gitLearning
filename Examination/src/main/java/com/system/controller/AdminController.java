...
public class AdminController
{
	...
	public String editStudentUI(Integer id, Model model) throws Exception
	{
		...
		if (studentCustom == null) { throw new CustomException("未找到该名学生"); }
		List<College> list = collegeService.finAll();
	...
	// 删除学生
	@RequestMapping(value = "/removeStudent", method =
	{
			RequestMethod.GET
	})
	...
	// 搜索学生
	@RequestMapping(value = "selectStudent", method =
	{
			RequestMethod.POST
	})
	...
	// 添加教师信息
	@RequestMapping(value = "/addTeacher", method =
	{
			RequestMethod.GET
	})
	...
	// 修改教师信息页面显示
	@RequestMapping(value = "/editTeacher", method =
	{
			RequestMethod.GET
	})
	public String editTeacherUI(Integer id, Model model) throws Exception
	{
		if (id == null) { return "redirect:/admin/showTeacher"; }
		TeacherCustom teacherCustom = teacherService.findById(id);
		if (teacherCustom == null) { throw new CustomException("未找到该名学生"); }
		List<College> list = collegeService.finAll();
	...
	// 搜索教师
	@RequestMapping(value = "selectTeacher", method =
	{
			RequestMethod.POST
	})
	...
	// 添加课程
	@RequestMapping(value = "/addCourse", method =
	{
			RequestMethod.GET
	})
	...
	// 修改教师信息页面显示
	@RequestMapping(value = "/editCourse", method =
	{
			RequestMethod.GET
	})
	public String editCourseUI(Integer id, Model model) throws Exception
	{
		if (id == null) { return "redirect:/admin/showCourse"; }
	...
	// 搜索课程
	@RequestMapping(value = "selectCourse", method =
	{
			RequestMethod.POST
	})
	...
	// 普通用户账号密码重置处理
	@RequestMapping(value = "/userPasswordRest", method =
	{
			RequestMethod.POST
	})
	public String userPasswordRest(Userlogin userlogin) throws Exception
	{
		...
		if (u != null)
		{
			if (u.getRole() == 0) { throw new CustomException("该账户为管理员账户，没法修改"); }
